...
final int TIPS_MASS = 60;//64 //original 45
final int HAND_MASS = 650;//650 //original 600
  ...
  if (sound==null)
  {
    ...
    if (returnVal == JFileChooser.APPROVE_OPTION)
    {
        ...
        {  
           ...
           btnPause.setAudio(sound, sound2); 
           btnStop.setAudio(sound, sound2);
        }
        else
        {
           btnPlay.setAudio(sound, null); 
           btnPause.setAudio(sound,null);
...
void createBotones()
{
  btnPlay = new BtnPlay(22,50,80,80, "");
  btnPause = new BtnPause(122,50,80,80,"");
  btnStop = new BtnStop(222,50,80,80,"");
  
  BtnTriggerSound btnEffect1 = new BtnTriggerSound( 42, 200, 230, 115, "", minim.loadSample("../sonidos/one-scratch.aif", 512));
  BtnTriggerSound btnEffect11 = new BtnTriggerSound( 42, 315, 230, 115, "", minim.loadSample("../sonidos/scratch-blast.aif", 512));
  
  BtnTriggerSound btnEffect2 = new BtnTriggerSound(405, 60, 80, 80, "Whiteass", minim.loadSample("../sonidos/whiteass-rap.aif", 512));
  BtnTriggerSound btnEffect3 = new BtnTriggerSound(505, 60, 80, 80, "Balloon", minim.loadSample("../sonidos/balloon-pop.aif", 512));
  
  BtnTriggerSound btnEffect4 = new BtnTriggerSound(405, 200, 80, 80, "Ratata", minim.loadSample("../sonidos/ratatat.aif", 512));
  BtnTriggerSound btnEffect5 = new BtnTriggerSound(505, 200, 80, 80, "Squeal", minim.loadSample("../sonidos/animal-squeal.aif", 512));
  
  BtnTriggerSound btnEffect6 = new BtnTriggerSound(405, 340, 80, 80, "Cow", minim.loadSample("../sonidos/latin-singletone-cow.aif", 512));
  BtnTriggerSound btnEffect7 = new BtnTriggerSound(505, 340, 80, 80, "Beat", minim.loadSample("../sonidos/white-homeboy-beat.aif", 512));
  
  botones.add(btnPlay);
  botones.add(btnPause);
  botones.add(btnStop);
  botones.add(btnEffect1);
  botones.add(btnEffect11);
  botones.add(btnEffect2);
  botones.add(btnEffect3);
  botones.add(btnEffect4);
  botones.add(btnEffect5);
  botones.add(btnEffect6);
  botones.add(btnEffect7);
}
